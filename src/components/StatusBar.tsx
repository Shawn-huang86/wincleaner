...
export const StatusBar: React.FC<StatusBarProps> = ({
  ...
  return (
    <div className="flex items-center justify-between px-3 py-2.5 bg-gradient-to-r from-gray-50 to-gray-100 border-t border-gray-200 h-[45px]">
      ...
      <button
        ...
        className="flex items-center gap-1.5 px-3 py-1 bg-gradient-to-r from-red-600 to-red-700 text-white font-medium rounded-md hover:from-red-700 hover:to-red-800 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 text-sm"
      >
